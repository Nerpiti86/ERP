...
| `21_maestro_productos_servicios.md` | Diseño base del maestro unificado de productos y servicios | Núcleo persistente implementado; servicios e interfaz pendientes |
